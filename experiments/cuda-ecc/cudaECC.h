...
*/
__host__ __device__ int uECC_make_key(uint8_t *public_key, uint8_t *private_key, uECC_Curve curve);
...
*/
__device__ void uECC_decompress(const uint8_t *compressed, uint8_t *public_key, uECC_Curve curve);
...
*/
__device__ int uECC_valid_public_key(const uint8_t *public_key, uECC_Curve curve);
...
*/
__device__ int uECC_compute_public_key(const uint8_t *private_key, uint8_t *public_key, uECC_Curve curve);
...
*/
int __host__ __device__ uECC_verify(const uint8_t *public_key,
                const uint8_t *message_hash,
                unsigned hash_size,
